...
; Jessie & James
	...
	db $FF, 46, WEEZING, 45, LICKITUNG, 46, ARBOK, 48, MEOWTH, 48, VICTREEBEL, 0 ; Mansion B1F
	db $FF, 49, WEEZING, 48, LICKITUNG, 49, ARBOK, 51, MEOWTH, 51, VICTREEBEL, 0 ; Viridian Gym
; Unused
	db 29, WEEZING, 0
	db 33, WEEZING, 0
